          ...
          >
            <div className="space-y-4">
              ...
              >
                ...
                From sizzling appetizers to signature desserts,
                every dish is crafted to delight your senses.
              </motion.p>
            </div>
                  ...
                  return (
                    <CarouselItem key={slide.id}>
                      <motion.div
                        ...
                        className="relative h-80 w-full lg:min-h-[420px]"
                      >
                        <Image
                  ...
                  return (
                    <CarouselItem key={slide.id}>
                      ...
                      >
                        ...
                        <div className="h-12.5 w-2 rounded-full bg-primary" />
